...
public class CancelProduct {
    private String nodeId,userId,sellerId,productId,productSize,productQty,cancelReason,cancelComment,cancelDate,cancelTime,productSellingPrice,productOriginalPrice;
